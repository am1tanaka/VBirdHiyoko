...
public class RigidbodyBlockPushTests
{
    ...
    public IEnumerator NormalBlockPushTestsWithEnumeratorPasses()
    {
        ...
        // 氷3を押す
        target.z+=2;
        yield return AM1TestUtil.ClickAndAssert(target, target+Vector3.back, "氷3");
    ...
    [UnityTest]
    public IEnumerator RigidbodyBlockPushTestsWithEnumeratorPasses()
    {
        yield return AM1TestUtil.StartStage("TestStageRigidbodyBlock");
        yield return AM1TestUtil.WaitCanAction();
        Time.timeScale = 2;
